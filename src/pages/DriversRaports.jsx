...
const DriversRaports = () => {
  ...
  useEffect(() => {
        ...
        try {
          ...
          if (res.status === 200) {
            if (res.data.data.length > 0) {
              ...
              seterrorMessage("No Drivers Exists");
            }
          }
    ...
    PrepareArrayItems(FilteredDrivers, setcurrentDrivers)

  }, [currentPage, Drivers, RunOneTime, FilteredDrivers]);
      ...
      <div className="border rounded-xl border-gray-200 shadow-lg">
        ...
        <div className="py-4 border-b border-gray-300 px-3 flex items-center gap-4 justify-end">
          ...
          <input
            type="text"
            value={SearchQuery}
            onChange={(e) => dataFilter(Drivers, setFilteredDrivers, e.target.value)}
